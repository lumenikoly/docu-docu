...
Общие компоненты берут локальные контуры Lucide из
`web/src/design/icons.ts`. Добавляйте новую иконку в реестр и создавайте её через `createIcon`: без подписи она получает
