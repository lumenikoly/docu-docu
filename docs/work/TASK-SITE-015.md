...
- [x] `AC-01` React управляет диапазоном, фильтрами, списком файлов, оболочкой
  деталей, уведомлениями, мобильной панелью файлов, редактором проверки, выбором
  связанного файла и сообщениями о состоянии.
- [x] `AC-02` Changes переиспользует компоненты и API Discussions из
  TASK-SITE-012 без второй реализации.
- [x] `AC-03` `ChangeSetReport`, Changes API, семантическое и отрисованное
  сравнение, CodeMirror Merge, якоря проверки и семантика Git сохраняются.
- [x] `AC-04` Диапазоны, фильтры, выбор файла, проверка, ошибки, мобильный режим
