...
sequenceDiagram
    ...
    Human->>UI: Открыть общую панель или выбрать «Обсудить» у задачи
...
- «Обсудить» у задачи выбирает её канонический документ и не меняет порядок
  общей очереди; «Спросить» остаётся разовым разговором вне обсуждений.
