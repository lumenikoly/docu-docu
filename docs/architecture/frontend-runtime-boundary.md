...
React и Base UI приняты как целевой фундамент следующих этапов миграции. Vite 8
уже собирает браузерные ресурсы. [ADR-008](../decisions/ADR-008.md) фиксирует
границы целевого состояния; этот документ различает их с действующей
реализацией.
