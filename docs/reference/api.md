...
| Changes HTTP API | Любой locale portal `serve` | `ChangeSetReport` и специальные представления документации | Читает локальный Git и активный locale root, ничего не меняет | [OpenAPI](../contracts/changes.openapi.yaml), [поведение](../contracts/changes-http.md) |
